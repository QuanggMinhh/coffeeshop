    ...
    <div class="main">
        <form action="" method="POST" class="form" id="form-1">
            ...
            <div class="form-group">
                ...
                <input id="fullname" name="hovaten" type="text" placeholder="Vo Quang Minh" class="form-control" />
                <span class="form-message"></span>
            </div>
            <div class="form-group">
                <label for="fullname" class="form-label">Tên tài khoản</label>
                <input id="fullname" name="taikhoan" type="text" placeholder="Minh Vo" class="form-control" />
                <span class="form-message"></span>
            </div>

            <div class="form-group">
                <label for="email" class="form-label">Email</label>
                <input id="email" name="email" type="text" placeholder="minh@email.com" class="form-control" />
                <span class="form-message"></span>
            </div>
            ...
            <div class="form-group">
                ...
                <span class="form-message"></span>
                <input style="background-color: rgb(186, 52, 3);" class="form-submit" type="submit" name="dangky" value="Đăng ký">
