            ...
            <ul class="card-list">
                <li class="card-item">
                    <div class="card-item-img">
                        <img style="width: fit-content;" src="image/mypic.jpg"></img>
                    </div>
                    ...
                    <div class="social-media-list">
                        <a href="https://www.facebook.com/minh.voquang.92775" class="social-media-item"><i class="fab fa-facebook facebook-icon"></i></a>
                        <a href="https://www.youtube.com/channel/UCxQ-hZo8FyDU13cPeWbTO2g" class="social-media-item"><i class="fab fa-youtube"></i></a>
                        <a href="https://www.instagram.com/iamminh_1203/" class="social-media-item"><i class="fab fa-instagram"></i></a>
                        <a href="https://github.com/QuanggMinhh" class="social-media-item"><i class="fab fa-github"></i></a>
                    </div>
