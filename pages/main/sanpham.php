...
?>
   <div class="warpper_deital">
      <div class="hinhanh_sanpham">
         <img style="width:default" src="admincp/modules/quanlysanpham/uploads/<?php echo $row_chitiet['hinhanh'] ?>">
      </div>
      <form class="form-sp" action="pages/main/giohang/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?>" method="POST">
         <div class="chitiet_sanpham">
            ...
            <div class="input-themcart" style="background-color: rgb(186, 52, 3);">
               <i class="fa-solid fa-cart-plus"></i>
               <input style="background-color: rgb(186, 52, 3);" class="themgiohang" type="submit" name="themgiohang" value="Thêm Giỏ Hàng">
            </div>
         </div>
      </form>
   </div>
