            ...
            ?>
                ...
                <tr>
                    <td colspan="8">
                        ...
                        ?>
                            <p style="margin-bottom: 10px;"><a href="index.php?quanly=thongtinthanhtoan" class="btn btn-success" style="text-decoration: none; font-weight: bold; font-size: larger;">Hình thức thanh toán</a></p>
                        <?php
                        } else {
